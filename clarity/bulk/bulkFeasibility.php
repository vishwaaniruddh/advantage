...
<div class="row">
    <div class="col-sm-12 grid-margin" style="    padding: 5%;box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;">

<p style="text-align:right;"><a href="../excelformats/BulkMaterialDispatchFormatVendor.xlsx" download>Excel Format</a></p>
