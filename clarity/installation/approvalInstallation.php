...
<form action="<? $_SERVER['PHP_SELF']; ?>?type=<?= $type; ?>&atmid=<?= $atmid; ?>&installationId=<?= $installationId; ?>"
    method="POST">
    <div class="row">
        <div class="col-sm-12">
            ...
            if ($sql_result) {
                ...
                if ($getcheckrecordsSql) {
                    ...
                    if ($getcheckrecordsSql_result) {
                        ...
                        // echo $actionsql = "UPDATE installationCheckpoints SET $type = '1', $typeBy='$userid'";
                        echo $actionsql = "UPDATE installationCheckpoints SET $type = '1', $typeBy='$userid' where installationID='".$thisinstallationId."'";
