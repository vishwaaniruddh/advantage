        ...
        <div class="card">
            <div class="card-block" style="overflow:auto;">
                ...
                <div class="row">
                    ...
                    if ($status == '0') {
                        $qty_sql = " select material,count(1) as total from Inventory where status in(0,1) group by material ";
                    } else if ($status == '1') {

                        $qty_sql = " select material,count(1) as total from Inventory where status in(1) group by material ";

                    }


                    $groupsql = mysqli_query($con, $qty_sql);
                ...
                if ($start_window > 1) {
                    ...
                    echo "<li class='paginate_button'><a href='?page=1&&material=$material_name&status=$status'>First</a></li>";
                    echo '<li class="paginate_button"><a href="?page=' . ($start_window - 1) . '&&material=' . $material_name . '&status='.$status.'">Prev</a></li>';
                }
                ...
                for ($i = $start_window; $i <= $end_window; $i++) {
                    ...
                    <li class="paginate_button <? if ($i == $current_page) {
                        ...
                        <a href="?page=<?= $i; ?>&&material=<?= $material_name; ?>&status=<?= $status; ?>">
                            <?= $i; ?>
                        </a>
                    </li>
                ...
                if ($end_window < $total_pages) {
                    ...
                    echo '<li class="paginate_button"><a href="?page=' . ($end_window + 1) . '&&material=' . $material_name . '&status='.$status.'">Next</a></li>';
                    echo '<li class="paginate_button"><a href="?page=' . $total_pages . '&&material=' . $material_name . '&status='.$status.'">Last</a></li>';
                }
                echo '</ul></div></div>';
