...
<script>
    alert('Done');
    window.location.href="./bulk_vendor_materialRecived.php";
</script>
            <?php
        }
        ?>
        ...
        <div class="card">
            <div class="card-block">
                <h5 style="font-weight: 600;">Update Tracking Status: <span
                        style="color:red;"><?php echo $challan_no; ?></span>
                </h5>
                <hr>
                <form
                    ...
                    <div class="row">
                        ...
                        <div class="grid-margin col-sm-12">
                            ...
                            <input type="text" name="challanNumber" class="form-control" value="<?php echo $challan_no; ?>" required />
                        </div>
                    </div>
                    <div class="row">
                        <div class="grid-margin col-sm-12">
                            ...
                            <input type="text" name="receiversName"
                                value="<?php echo $_SESSION['ADVANTAGE_username']; ?>" class="form-control" required />
                        </div>
                        <div class="grid-margin col-sm-12">
