            ...
            <table id="example" class="table table-bordered table-striped table-hover dataTable js-exportable no-footer"
                ...
                <thead>
                    <tr class="table-primary">
                        <th>Sr No</th>
                        <th>atmid</th>
                        <th>Ir Report Softcopy</th>
                        <th>Ir Report Hardcopy</th>
                        <th>Update Site Live Date</th>
                        <th>created_at</th>
                        <th>created_by</th>
                ...
                <tbody>
                    ...
                    while ($sql_result = mysqli_fetch_assoc($sql)) {
                        ...
                        $isHardopyIrReportGiven = $sql_result['isHardopyIrReportGiven'];
                        $hadrdcopyIRPath = $sql_result['hadrdcopyIRPath'];
                        $hardcopyReceivedBy = $sql_result['hardcopyReceivedBy'];
                        $hardcopyReceivedAt = $sql_result['hardcopyReceivedAt'];
                        $liveDate = $sql_result['liveDate'];
                        $id = $sql_result['id'];
...
<?
    ...
    <a class="btn btn-primary" href="./uploadirreport.php?atmid=<?= $atmid; ?>">Upload Softcopy
        IR Report</a>
...
if ($isHardopyIrReportGiven == 1) {
    ?>
    <a href="<?= $hadrdcopyIRPath; ?>">View</a>
    <br>
    <span>Uploaded By : <?= getUsername($hardcopyReceivedBy) ; ?></span>
    <br>
    <span>Uploaded At : <?= $hardcopyReceivedAt ; ?></span>

<?
}else{
?>
<a class="btn btn-info"
    href="./acknowledgeHardcopyirReport.php?atmid=<?= $atmid; ?>">Acknowledge Hardcopy IR
    Report</a>
<?
}
...
<td>
    ...
    <a class="btn btn-secondry" href="./updateLiveStatus.php?atmid=<?= $atmid; ?>&id=<?php echo $id ; ?>">Update Live Date</a>
<? } ?>
